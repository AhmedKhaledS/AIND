...
def custom_score(game, player):
    ...
    return float(7.5 * my_moves - 2 * opponent_moves + blank_slots / 26)
...
def custom_score_3(game, player):
    ...
    opponent_moves = float(len(game.get_legal_moves(game.get_opponent(player))))
    blank_slots = float(len(game.get_blank_spaces()))
    return float(my_moves - 2*opponent_moves + blank_slots)
...
def custom_score_4(game, player):
    ...
    opponent_moves = float(len(game.get_legal_moves(game.get_opponent(player))))
    blank_slots = float(len(game.get_blank_spaces()))
    return float(2 * my_moves - 3 * opponent_moves)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for move in game.get_legal_moves(self):
            current_move_score = self._min_value(game.forecast_move(move), depth - 1)
    ...
    def _max_value(self, game, depth):
        ...
        for move in legal_moves:
            value_of_game = max(value_of_game, self._min_value(game.forecast_move(move), depth - 1))
    ...
    def _min_value(self, game, depth):
        ...
        value_of_game = float("inf")
        for move in legal_moves:
            value_of_game = min(value_of_game, self._max_value(game.forecast_move(move), depth - 1))
